...
setuptools.setup(
    ...
    packages=[
        ...
        "loop_tool_service.models.rllib.config.ddpg",
        "loop_tool_service.models.rllib.config.dqn",
        "loop_tool_service.models.rllib.config.dreamer",
        "loop_tool_service.models.rllib.config.es",
        "loop_tool_service.models.rllib.config.impala",
        "loop_tool_service.models.rllib.config.pg",
        "loop_tool_service.models.rllib.config.ppo",
        "loop_tool_service.models.rllib.config.qmix",
